      ...
      <section className="dark:bg-gray-800 dark:text-gray-100">
        <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
          <div className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
            <h1 className="text-5xl font-bold font-heading leading-none sm:text-6xl">
              Your One Stop Solution for{" "}
              <span className="text-primary-400">Flashcard </span>
            </h1>
            <p className="mt-6 mb-8 text-lg sm:mb-12">
              Make your own personalized flashcard. Browse many amazing
              flashcard for memorization of your study needs. Browse for{" "}
